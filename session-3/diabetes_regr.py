...
class Variable(object):
    def __init__(self, value):
        ...
        self.change = 0.0  # keep track of gradient change for momentum optimizer
...
class OptimizerSGD_Momentum:
    ...
    def step(self):
        for param in self.parameters:
            new_change = np.mean(param.grad, axis=0) * self.learning_rate + self.momentum * param.change
            param.value -= new_change
            param.change = new_change
...
# optimizer = OptimizerSGD_Momentum(
#     model.parameters(),
#     LEARNING_RATE,
#     momentum=0.8
# )
