...
parser.add_argument('-run_name', default='all_features_emo_transfer', type=str)
parser.add_argument('-num_epochs', default=5000, type=int)
parser.add_argument('-batch_size', default=64, type=int)
parser.add_argument('-learning_rate_g', nargs="+", default=[1e-5, 1e-4], type=float)
parser.add_argument('-learning_rate_d', nargs="+", default=[1e-5, 1e-4], type=float)
